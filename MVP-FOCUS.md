...
2. **Chat** with your PA  
3. Capture in **Inbox**  
4. Track **Oppgaver** and **Eiendeler** (net worth on home)  
...
|--------|-------|---------|
| Hjem | `/home` | Greeting, net worth, priorities |
| Chat | `/chat` | Talk to PA |
| Inbox | `/inbox` | Capture items |
| Oppgaver | `/tasks` | Task list |
| Eiendeler | `/assets` | Assets + estimated values |
...
- Create/edit forms in Next.js (lists are read-only except Inbox + Chat + Settings)  
...
- [ ] Chat answers with your data context  
- [ ] Inbox capture works  
- [ ] Task and asset lists load  
...
4. **Chat streaming** — SSE from FastAPI  
5. **Re-enable modules one by one** — Dashboard → Documents → Projects  
